...
(function() {
    function buildQuiz() {
        ...
        myQuestions.forEach((currentQuestion, questionNumber) => {
            output.push(`<div class="navigation-number" id="${questionNumber}">${questionNumber + 1}</div> `);
        });
            ...
            for (letter in currentQuestion.answers) {
                answers.push(
                    `<label class="answer">
                        ...
                        <p class="answer-text"> ${currentQuestion.answers[letter]} </p>
                        <span class="answer-letter x"><img src="images/close.svg" alt="Close"></span>
                     </label>
                     `
                );
            }
        ...
        output.push(
            ` <div class="slide-container">
                <div class="score-elements-container">
                    <div class="score-icon"><img src="images/score.svg" alt="Cup"></div>
...
*/
    ...
    const myQuestions = questions[localStorage.getItem('title')];
