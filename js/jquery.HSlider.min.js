!(function(i) {
    var n = { easing: 'ease', animationTime: 800, pagination: !0 };
    ...
    (i.fn.HSlider = function(t) {
        ...
        (i.fn._render = function() {
            ...
            var t = n;
            i('section.active').removeClass('active'),
                i('.pagination li a.active').removeClass('active'),
                i('section[data-index=' + t + ']').addClass('active'),
        ...
        (i.fn._renderPagination = function() {
            e.pagination &&
                (i("<ul class='pagination'>" + l + '</ul>').prependTo('body'),
        ...
        (i.fn._bindEvent = function() {
            return (
                i(window).on('hashchange', a._render),
        ...
        (i.fn._initStyle = function() {
            return (
                a.addClass('HSlider').css({ position: 'relative', width: '100%', height: '100%' }),
                i.each(s, function(n) {
                    i(this)
                        .css({ position: 'absolute', width: '100%', height: '100%', left: 100 * n + '%' })
                        .addClass('section')
                        .attr('data-index', n + 1),
                        i(this)
                        .find('img')
                        .css({ minWidth: '100%', minHeight: '100%', position: 'absolute', zIndex: 1 }),
                        ...
                        1 == e.pagination &&
                        (l += "<li><a data-index='" + (n + 1) + "' href='#" + (n + 1) + "'></a></li>");
                }),
                i(this)
            );
        }),
